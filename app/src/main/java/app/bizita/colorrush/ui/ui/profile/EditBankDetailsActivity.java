...
//    private View parent_view;
    ...
    Button btnSetPrimary, btnRemove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        bank_id = i.getStringExtra("bank_id");
...
//        parent_view = findViewById(android.R.id.content);
        ...
        btnSetPrimary = findViewById(R.id.btnSetPrimary);
        ...
        btnRemove.setOnClickListener(new View.OnClickListener() {
         ...
         sweetAlertDialog = new SweetAlertDialog(EditBankDetailsActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE);
...
//                                finish();
    ...
    public void GetProfile() {
        ...
        Call<GetbankdetailModel> loginModelCall = RetrofitHelper.createService(RetrofitHelper.Service.class).GetbankdetailModel("Bearer " + token, hashMap);
        loginModelCall.enqueue(new Callback<GetbankdetailModel>() {

            @SuppressLint("SetTextI18n")
            @Override
            public void onResponse(@NonNull Call<GetbankdetailModel> call, @NonNull Response<GetbankdetailModel> response) {
                GetbankdetailModel object = response.body();
                ...
                if (response.isSuccessful()) {
                    ...
                    if (object.getData().getBank().getBankName() != null) {
                        edbank_name.setText(object.getData().getBank().getBankName() + "");
                    }
                    if (object.getData().getBank().getAccountHolderName() != null) {
                        edAccountHolderName.setText(object.getData().getBank().getAccountHolderName() + "");
                    }
                    if (object.getData().getBank().getBankAccountNo() != null) {
                        edbank_account_number.setText(object.getData().getBank().getBankAccountNo() + "");
                        edbank_re_account_number.setText(object.getData().getBank().getBankAccountNo() + "");
                    }
                    if (object.getData().getBank().getBankBranch() != null) {
                        edbank_branch_name.setText(object.getData().getBank().getBankBranch() + "");
                    }
                    if (object.getData().getBank().getBankIfsc() != null) {
                        edbank_ifsc_code.setText(object.getData().getBank().getBankIfsc() + "");
                    }

                    if (object.getData().getBank().getImage() != null) {
                        Glide.with(EditBankDetailsActivity.this)
                                .load(BuildConstants.Main_Image + object.getData().getBank().getImage().toString().replace("public", "storage") + "")
                                .placeholder(R.drawable.ic_user)
//                    .transition(DrawableTransitionOptions.withCrossFade(500))
                                .into(imageViewCancelCheque);
                    }
...
//                    fab.setAlpha(1f);
                    try {
                        ...
                        SweetAlertDialog sweetAlertDialoga = new SweetAlertDialog(EditBankDetailsActivity.this, SweetAlertDialog.CUSTOM_IMAGE_TYPE);
            ...
            @Override
            public void onFailure(@NonNull Call<GetbankdetailModel> call, @NonNull Throwable t) {
                progress_bar1.setVisibility(View.GONE);
                nested_content.setVisibility(View.GONE);
//                fab.setAlpha(1f);
                t.printStackTrace();
    ...
    public void SetPrimaryAccout() {


        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("bank_id", bank_id + "");
        progress_bar1.setVisibility(View.VISIBLE);
        Call<SetPrimaryAccountModel> loginModelCall = RetrofitHelper.createService(RetrofitHelper.Service.class).SetPrimaryAccountModel("Bearer " + token, hashMap);
        loginModelCall.enqueue(new Callback<SetPrimaryAccountModel>() {

            @SuppressLint("SetTextI18n")
            @Override
            public void onResponse(@NonNull Call<SetPrimaryAccountModel> call, @NonNull Response<SetPrimaryAccountModel> response) {
                SetPrimaryAccountModel object = response.body();
...
//                    fab.setAlpha(1f);
            ...
            @Override
            public void onFailure(@NonNull Call<SetPrimaryAccountModel> call, @NonNull Throwable t) {
                progress_bar1.setVisibility(View.GONE);
                nested_content.setVisibility(View.GONE);
//                fab.setAlpha(1f);
                t.printStackTrace();
    ...
    public void DeleteAccout() {
        ...
        hashMap.put("bank_id", bank_id + "");
        progress_bar1.setVisibility(View.VISIBLE);
        Call<RemoveBankModel> loginModelCall = RetrofitHelper.createService(RetrofitHelper.Service.class).RemoveBankModel("Bearer " + token, hashMap);
        loginModelCall.enqueue(new Callback<RemoveBankModel>() {

            @SuppressLint("SetTextI18n")
            @Override
            public void onResponse(@NonNull Call<RemoveBankModel> call, @NonNull Response<RemoveBankModel> response) {
                RemoveBankModel object = response.body();
...
//                    fab.setAlpha(1f);
            ...
            @Override
            public void onFailure(@NonNull Call<RemoveBankModel> call, @NonNull Throwable t) {
                progress_bar1.setVisibility(View.GONE);
                nested_content.setVisibility(View.GONE);
//                fab.setAlpha(1f);
                t.printStackTrace();
...
//            Snackbar.make(parent_view, "Bank Name Required", Snackbar.LENGTH_SHORT).show();
        ...
        if (holdername.isEmpty()) {
            ...
            RequestBody bankid = RequestBody.create(MediaType.parse("text/plain"), bank_id + "");
...
//                assert fileImage2 != null;
            ...
            Call<UpdatebankdetailModel> registerModelCall = RetrofitHelper.createService(RetrofitHelper.Service.class).UpdatebankdetailModel("Bearer " + token, hashMap);
            registerModelCall.enqueue(new Callback<UpdatebankdetailModel>() {

                @Override
                public void onResponse(@NonNull Call<UpdatebankdetailModel> call, @NonNull Response<UpdatebankdetailModel> response) {
                    UpdatebankdetailModel object = response.body();
                    if (response.isSuccessful()) {
                ...
                @Override
                public void onFailure(@NonNull Call<UpdatebankdetailModel> call, @NonNull Throwable t) {
                    progress_bar.setVisibility(View.GONE);
                    fab.setAlpha(1f);
                    t.printStackTrace();
    ...
    public boolean isNetworkAvailable() {
        return BaseClass.isNetworkAvailable(EditBankDetailsActivity.this);
    }

    private void selectImageProfile() {
        final CharSequence[] options = {"From Camera", "From Gallery", "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(EditBankDetailsActivity.this);
...
//        currentPhotoPath = image.getAbsolutePath();
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(EditBankDetailsActivity.this, new String[]{CAMERA}, PERMISSION_REQUEST_CODE);
    }

    private void requestGalleryPermission() {
        ActivityCompat.requestPermissions(EditBankDetailsActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST);
    }

    private boolean checkCameraPermission() {
        int result1 = ContextCompat.checkSelfPermission(EditBankDetailsActivity.this, Manifest.permission.CAMERA);
        return result1 == PackageManager.PERMISSION_GRANTED;
    }

    private boolean checkGalleryPermission() {
        int result2 = ContextCompat.checkSelfPermission(EditBankDetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE);
