package app.bizita.colorrush.ui.ui.credit_amt;
...
public class CreditAmountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_credit_amount, container, false);
...
//        selectSandBoxEnv();
    ...
    private void searchAction() {
        ...
        if (email_id.isEmpty()) {
//            Snackbar.make(parent_view, "Points Required", Snackbar.LENGTH_SHORT).show();
...
//                    labelNotification.setText(object.getResultMarque() + "");
                                progress_bar.setVisibility(View.GONE);
                                fab.setAlpha(1f);
//                                Snackbar.make(parent_view, "Payment Successfull...", Snackbar.LENGTH_SHORT).show();
...
//                                    Snackbar.make(parent_view, jObjError.getString("message") + "", Snackbar.LENGTH_SHORT).show();
                    ...
                    new SweetAlertDialog(getActivity(), SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                            .setTitleText("Sorry Payment Failed")
    ...
    private void setupCitrusConfigs() {
        AppEnvironment appEnvironment = ((BaseApplication) ((AppCompatActivity) getActivity()).getApplication()).getAppEnvironment();
        if (appEnvironment == AppEnvironment.PRODUCTION) {
//            Toast.makeText(BuyMoneyActivity.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
//            Toast.makeText(BuyMoneyActivity.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
}